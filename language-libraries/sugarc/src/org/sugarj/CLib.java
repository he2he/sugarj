...
import org.sugarj.c.CSourceFileContent;
 ...
 */
public class CLib extends LanguageLib {
  ...
  private CSourceFileContent sourceContent;
  ...
  public File getLibraryDirectory() {
    if (libDir == null) { // set up directories first
      ...
      URL thisClassURL = CLib.class.getClassLoader().getResource(thisClassPath);
  ...
  public LanguageLibFactory getFactoryForLanguage() {
    return CLibFactory.getInstance();
  }
  ...
  public void setupSourceFile(RelativePath sourceFile, Environment environment) {
    outFile = environment.createOutPath(FileCommands.dropExtension(sourceFile.getRelativePath()) + "." + CLibFactory.getInstance().getOriginalFileExtension());
    sourceContent = new CSourceFileContent();
  }
  ...
  public void processNamespaceDec(IStrategoTerm toplevelDecl, Environment environment, IErrorLogger errorLog, RelativePath sourceFile, RelativePath sourceFileFromResult) throws IOException {
    ...
    RelativePath objectFile = environment.createOutPath(getRelativeNamespaceSep() + moduleName + "." + CLibFactory.getInstance().getGeneratedFileExtension());
