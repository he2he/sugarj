...
public class CSourceFileContent extends SourceFileContent {
  ...
  public boolean equals(Object o) {
    if (!(o instanceof CSourceFileContent))
      return false;

    CSourceFileContent other = (CSourceFileContent) o;
