...
public class CProcessor extends AbstractBaseProcessor {
  ...
  private static final String GCC_COMMAND = "gcc";
  ...
  public void init(RelativePath sourceFile, Environment environment) {
    ...
    outFile = environment.createOutPath(FileCommands.dropExtension(sourceFile.getRelativePath()) + "." + CLanguage.getInstance().getBaseFileExtension());
  }
